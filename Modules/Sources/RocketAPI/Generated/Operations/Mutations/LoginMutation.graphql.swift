...
public extension RocketAPI {
  nonisolated struct LoginMutation: GraphQLMutation {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation Login($email: String) { login(email: $email) { __typename id email token } }"#
      ))
    ...
    nonisolated public struct Data: RocketAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __parentType: any ApolloAPI.ParentType { RocketAPI.Objects.Mutation }
      ...
      ///
      /// Parent Type: `User`
      nonisolated public struct Login: RocketAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }

        @_spi(Execution) public static var __parentType: any ApolloAPI.ParentType { RocketAPI.Objects.User }
        @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
